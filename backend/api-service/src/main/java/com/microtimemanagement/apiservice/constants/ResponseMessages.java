...
public class ResponseMessages {
    public static final String USER_ASSIGNED_WITH_ROLE_SUCCESS = "Role assigned to user successfully.";
    ...
    public static final String USER_DETAILS_UPDATED = "Details Updated Sucessfully!!";
}
